 ...
 * ヘッドレスはあえて使わない: ヘッドレス Chrome はラスタライズ経路が
 * ヘッドフルと異なり、.claude/docs/architecture.md §2.6 では
 * ヘッドレス/jsdom 相当の計測が実ページの rAF 計測と**逆の結論**を
 * 出した事例が記録されている。ベンチ計測は必ず実際に画面表示される
 * ブラウザウィンドウで行う。
 */
